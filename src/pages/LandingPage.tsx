          ...
          {formations.map((formation) => (
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <p className="text-gray-500 text-sm mb-4">{formation.subtitle}</p>
                ...
                <div className="flex items-center gap-4 mb-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gray-400">({formation.reviews})</span>
                  </div>
                </div>

                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-2xl font-bold text-violet-600">{formation.price.toLocaleString()}</span>
